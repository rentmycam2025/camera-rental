...
import { howItWorksSteps, reviews, socialMedia, stats } from "../data/homeData";
import {
  FiArrowRight,
  FiMapPin,
  FiPhone,
...
const Home = ({
  ...
  return (
    <>
      <Helmet>
        <title>
          Rent My Cam - Camera & Lens Rental in Bengaluru | Affordable
          Photography Gear
        </title>
        <meta
          name="description"
          content="Rent professional cameras, lenses, and photography gear in Bengaluru. Affordable and instant access to top-tier cinema and photography equipment."
        />
        <meta
          name="keywords"
          content="camera rental Bengaluru, lens rental, photography gear rental, cinema camera hire, professional camera rental, affordable camera rental"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://rentmycam.in/" />
      </Helmet>
      <div className="bg-white min-h-screen space-y-16">
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 py-0">
          ...
          {isLoading ? (
            <Loader className="my-8 sm:my-10 h-[90vh]" />
          ) : (
